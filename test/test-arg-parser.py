...
parser.add_argument('--csv', dest='csv', type=str, help='Absolute path to the CSV export file from the Hydra GUI.',
                    required=True)
parser.add_argument('--currency', dest='currency', type=str,
                    help='Currency to be shown is the statistic tables. Default is USD', default='USD', action=CurrencyAction)
